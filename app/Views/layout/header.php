...
<html lang="en">
    ...
    <head>
        ...
        <link href="<?php echo base_url('template/lib/tempusdominus/css/tempusdominus-bootstrap-4.min.css') ?>"
            rel="stylesheet" />
            ...
            <div class="sidebar pe-4 pb-3">
                <nav class="navbar bg-light navbar-light">
                    <a href="index.html" class="navbar-brand mx-4 mb-3">
                        <h3 class="text-primary"><i class="fa fa-hashtag me-2"></i>Pariwisata</h3>
                    </a>
                    <div class="d-flex align-items-center ms-4 mb-4">
                        <div class="position-relative">
                            <img class="rounded-circle" src="<?php echo base_url('template/img/user.jpg') ?>" alt=""
                                ...
                                <a href="#" class="dropdown-item">
                                    <div class="d-flex align-items-center">
                                        <img class="rounded-circle"
                                            src="<?php echo base_url('template/img/user.jpg') ?>" alt=""
                                            style="width: 40px; height: 40px;">
                                        <div class="ms-2">
                                            <h6 class="fw-normal mb-0">Jhon send you a message</h6>
                                            <small>15 minutes ago</small>
